...
const HTMLStyle = new function() {
    ...
    this.createFolder = function(folder, view) {
        ...
        if(view === "list" && ($(window).width() >= 1024)) {
            ...
            nameClasses = "col-sm-7 col-md-7 col-lg-7 col-xl-7 col-xxl-7";
            iconClasses = "col-sm-1 col-md-1 col-lg-1 col-xl-1 col-xxl-1 w-auto";
        }
        ...
        const divColName = $("<a/>").attr({class: nameClasses+" folder-name text-decoration-none text-dark text-ellipsis", href: "javascript:;", id: folder.id, title: folder.name});
    ...
    this.createFile = function(file, view, shared) {
        ...
        divColR.append(divColIcon);
        const divColName = $("<a/>").attr({class: nameClasses+" file-name open-file text-decoration-none text-dark text-ellipsis", href: "javascript:;", id: file.id, name: file.originalName, title: file.originalName});
