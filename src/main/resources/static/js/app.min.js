...
const File = new function() {
    ...
    this.show = function(id, fileName, type, shared) {
        ...
        $("#fileViewModal").find(".modal-body").empty();
        const div = $("<div/>").attr({class: "col-sm-12 border-bottom border-success mt-2 mb-2"});
        const aShare = $("<a/>").attr({class: "float-end btn btn-sm btn-outline-success share-view-file", href:"javascript:;", id: id}).append('<i class="fa-solid fa-share-nodes"></i>');
        const aDownload = $("<a/>").attr({class: "float-end btn btn-sm btn-outline-success download-view-file", href:"javascript:;", id: id}).append('<i class="fa-solid fa-download"></i>');
        div.append(aShare).append(aDownload);
