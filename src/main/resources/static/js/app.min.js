...
const HTMLStyle = new function() {
    ...
    this.contextOfFile = function(file, shared, sharedFilesByYou) {
    ...
    this.createFile = function(file, view, shared, sharedFilesByYou) {
        var rowClasses = "col-sm-5 col-md-5 col-lg-5 col-xl-5 col-xxl-5";
        ...
        divColR.append(HTMLStyle.contextOfFile(file, shared, sharedFilesByYou));
        divCol.append(divColR);
        return divCol;
    };
    ...
    this.sharedWith = function(id, fileName) {
        ...
        let callBack = function(response) {
            if(response.success) {
                ...
                mainDiv.append(HtmlElement.div(nameColClasses+" fw-bold", "Shared with"));
                mainDiv.append(HtmlElement.div(dateTimeColClasses+" fw-bold", "Shared Datetime"));
                ...
                if(sharedFile) {
                    for(let index=0; index<sharedFile.toUsers.length; index++) {
                        ...
                        const userInfo = sharedInfo.userDTO.firstName+" "+sharedInfo.userDTO.lastName +"("+sharedInfo.userDTO.email+")";
    ...
    this.open = function(response) {
        ...
        if(response.data) {
            ...
            for(let index = 0; index < files.length; index++) {
                divFileRow.append(HTMLStyle.createFile(files[index], response.data.view, false, false));
            }
            if(files.length > 0) {
                if(folders.length > 0) {
        ...
        if(response.data) {
            ...
            if(sharedFilesWithU.length > 0) {
                ...
                for(let index = 0; index < sharedFilesWithU.length; index++) {
                    divSharedFileWithURow.append(HTMLStyle.createFile(sharedFilesWithU[index].file, response.data.view, true, false));
                }
            ...
            if(sharedFilesByU.length > 0) {
                ...
                for(let index = 0; index < sharedFilesByU.length; index++) {
                    divSharedFileByURow.append(HTMLStyle.createFile(sharedFilesByU[index].file, response.data.view, true, true));
                }
